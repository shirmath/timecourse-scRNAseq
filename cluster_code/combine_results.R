...
n_settings <- 36 #set number of settings for which results need to be combined
...
#save the dfs above 
saveRDS(beta_results_df, file = "mom_sims_beta_results.RDS")
saveRDS(Sigma_results_df, file = "mom_sims_Sigma_results.RDS")
saveRDS(A_results_df, file = "mom_sims_A_results.RDS")
saveRDS(A_support_df, file = "mom_sims_A_support_results.RDS")
